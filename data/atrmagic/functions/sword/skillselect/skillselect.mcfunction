...
execute as @a[scores={swordjobLv=5..,swordjobskill12=0}] at @s run tellraw @s [{"text":"[呪いの刃]","color":"white"},{"text":" 選択する","color":"green","clickEvent":{"action":"run_command","value":"/trigger atrtrigger.text set 31"}}]
execute as @a[scores={swordjobLv=5..,swordjobskill12=1}] at @s run tellraw @s [{"text":"[呪いの刃]","color":"white"},{"text":" 選択済み","color":"gray"}]
execute as @a[scores={swordjobLv=5..,swordjobskill13=0}] at @s run tellraw @s [{"text":"[剛毅突進]","color":"white"},{"text":" 選択する","color":"green","clickEvent":{"action":"run_command","value":"/trigger atrtrigger.text set 32"}}]
execute as @a[scores={swordjobLv=5..,swordjobskill13=1}] at @s run tellraw @s [{"text":"[剛毅突進]","color":"white"},{"text":" 選択済み","color":"gray"}]
