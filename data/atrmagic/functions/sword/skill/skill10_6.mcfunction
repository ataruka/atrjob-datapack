...
#damagetagadd
 #なし
#パーティクルと音
 playsound minecraft:entity.zombie.attack_iron_door master @a ~ ~ ~ 2 1.5
 playsound minecraft:item.axe.wax_off master @a ~ ~ ~ 2 2
