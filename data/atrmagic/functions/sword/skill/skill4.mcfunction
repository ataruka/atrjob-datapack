...
execute as @a[tag=swordskill4ef,scores={swordskill4ef=60}] at @s run summon armor_stand ~ ~ ~ {Marker:1b,Tags:["swordskill4ef.armorstand"],Invisible:1b}
execute as @e[tag=swordskill4ef.armorstand] at @s run data modify entity @s Rotation set from entity @a[distance=..0.0,limit=1,sort=nearest] Rotation
