...
#damage
 ...
 #斬撃飛ばしのアマスタ召喚
 execute anchored eyes rotated ~ 0 run summon armor_stand ^ ^ ^ {Marker:1b,Invisible:1b,Tags:["atrjob.swordskill10_2"]}
 execute if entity @s[team=atrjob.blue] run team join atrjob.blue @e[limit=1,sort=nearest,tag=atrjob.swordskill10_2,type=armor_stand]
 execute if entity @s[team=atrjob.green] run team join atrjob.green @e[limit=1,sort=nearest,tag=atrjob.swordskill10_2,type=armor_stand]
 execute if entity @s[team=atrjob.red] run team join atrjob.red @e[limit=1,sort=nearest,tag=atrjob.swordskill10_2,type=armor_stand]
 execute if entity @s[team=atrjob.yellow] run team join atrjob.yellow @e[limit=1,sort=nearest,tag=atrjob.swordskill10_2,type=armor_stand]
 execute as @e[limit=1,sort=nearest,tag=atrjob.swordskill10_2,type=armor_stand] at @s rotated as @a[limit=1,sort=nearest,tag=swordskill10attack_2] run tp @s ~ ~ ~ ~ 0
 scoreboard players set @e[limit=1,sort=nearest,tag=atrjob.swordskill10_2,type=armor_stand] swordskill10_2.armortick 20
 execute as @e[limit=1,sort=nearest,tag=atrjob.swordskill10_2,type=armor_stand] at @s run tp ^ ^ ^2
