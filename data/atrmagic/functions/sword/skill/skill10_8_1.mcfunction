...
#damage
 ...
 execute as @s[tag=swordskill10_8_12combo] at @s run function atrmagic:sword/skill/skill10/adddamage_1
 execute as @s[tag=swordskill10_8_12combo] at @s run playsound minecraft:block.beacon.power_select master @a ~ ~ ~ 2 1.5
 execute as @s[tag=swordskill10_8_12combo] at @s run function atrmagic:particle/sword/skill10/skill10_12
...
execute as @s at @s run particle minecraft:dust 0 0.973 0.843 1 ~ ~1 ~ 0.5 1 0.5 0 20 force
